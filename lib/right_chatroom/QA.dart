...
class _QAState extends State<QA> {
  ...
  List<String> reply = ['asked at 4:16PM'];
...
class QA2 extends StatefulWidget {
  @override
  _QA2State createState() => _QA2State();
}

class _QA2State extends State<QA2> {
  final TextEditingController myController = new TextEditingController();
  int _value = 1;
  List<String> picUrl = ['img/thumbnail/07.jpg'];
  List<String> question = [
    'Impossible considered invitation him men instrument saw celebrated unpleasant.',
  ];
  List<String> name = ['Morris Romero '];
  List<String> reply = ['asked at 4:25PM'];
  List<Color> backColor = [Colors.white];
