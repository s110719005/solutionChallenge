...
class DividerOpenRoom extends StatefulWidget {
  @override
  _DividerOpenRoomState createState() => _DividerOpenRoomState();
}

class _DividerOpenRoomState extends State<DividerOpenRoom> {
                            ...
                            Column(
                              children: <Widget>[
                                Padding(
                                  ...
                                  child: Image.asset(
                                    'assets/icon/SeminarDivider/opendoor_blue.png',
                                    width: 40,
                                  ),
                                ),
                                Text(
