...
typedef void BoolCallback(bool testbool);

class Left_tool extends StatefulWidget {
  @override
  _Left_toolState createState() => _Left_toolState();
}

class _Left_toolState extends State<Left_tool> {
  List<String> hT = [
    'Mouse',
    'Text',
    'Pen',
          ...
          Expanded(
            ...
            child: Material(
              ...
              child: Column(
                ...
                children: [
                  Show_Icon2('Mouse', '/icon/left_tool/Mouse.png', 0, null),
                  Visibility(
                    visible: ifAddTool,
                    child:
                  ...
                  Show_Icon2('Eraser', '/icon/left_tool/Eraser.png', 3, null),
                  Show_Icon2(
                      'Rectangle', '/icon/left_tool/rectangle.png', 4, null),
                  Show_Icon2('Circle', '/icon/left_tool/Circle.png', 5, null),
                  Show_Icon2('Line', '/icon/left_tool/Line.png', 6, null),
  ...
  Widget BoardIcon(String hoverText, String iconPath) {
    return Padding(
      ...
      child: Ink(
        ...
        width: 40,
        decoration: BoxDecoration(
          border: Border.all(color: _boardBorderColor, width: 1.5),
          color: Colors.white,
          shape: BoxShape.circle,
        ),
        child: Padding(
            ...
            child: Tooltip(
              ...
              child: Transform.scale(
                scale: 1.5,
                child: IconButton(
                  icon: Image.asset(iconPath, color: _boardColor), //
                  hoverColor: Colors.grey[300],
                  splashRadius: 12,
                  onPressed: () {
                    setState(() {
